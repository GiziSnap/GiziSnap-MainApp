...
const Preload = ({ children }: Readonly<{ children: React.ReactNode }>) => {
  ...
  return (
    <div className='relative flex h-screen items-center justify-center overflow-hidden'>
      <div
        ref={curtainRef}
        className='absolute top-0 left-0 h-full w-full origin-top scale-y-0 transform bg-white'
      ></div>
      <div
        ref={loaderRef}
      ...
      >
        ...
        <p className='mt-2 text-lg'>Harap tunggu sebentar.</p>
        <div className='mt-4'>
