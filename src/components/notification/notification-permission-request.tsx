      ...
      try {
        ...
        if (permissionStatus !== 'granted') {
          ...
          if (permission === 'granted') {
            ...
            toast.error(
              'Notifikasi diblokir. Anda dapat mengizinkan notifikasi di pengaturan browser.',
            );
          } else {
            toast.info(
              'Izin notifikasi diabaikan. Anda dapat mengizinkan notifikasi di pengaturan browser.',
            );
          }
        }
      } catch (error) {
